...
var htmlSrc =  'src/**/*.html',                  // html源文件路径       
    htmlDist = './dist/www',                       // html输出路径
	styleSrc = ['src/common/sass/common.scss', 'src/**/*.scss'],                    // 样式源文件路径
	styleDist = './dist/css',                      // 样式输出路径
	scriptSrc = 'src/lib/*.js',
	scriptDist = './dist/js',
	imgSrc =  'src/img/**/*',
	imgDist = './dist/img',
	fontSrc = 'src/common/sass/font/*.+(eot|svg|ttf|woff)',   // 不要生成无用的font目录和_iconfont.sass文件
	fontDist = './dist/css';
...
gulp.task('default', function (callback) {
  runSequence(["clean","html",'styles',"scripts","images", "browserSync","fonts",'watch'],callback)
});